...
vector<string> merk_kendaraan;
vector<string> plat_kendaraan;
vector<string> warna_kendaraan;
vector<system_clock::time_point> waktu_kendaraan;
...
int main(){
    system("cls");
    petugas petugas;
    string *nama_petugas = &petugas.nama,*id_petugas = &petugas.id;
    kendaraan mobil;
